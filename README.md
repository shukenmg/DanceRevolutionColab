...
- Due to the lack of 3D dance data in hand, we did not test our approach on 3D data. While there is a wonderful paper "Learn to Dance with AIST++: Music Conditioned 3D Dance Generation"(https://arxiv.org/abs/2101.08779) that explores on music-conditioned 3D dance generation and release a 3D dance dataset paired with music.      
