...
- Due to the lack of 3D dance data in hand, we did not test our approach on 3D data. But we believe the proposed approach should also work on 3D data since the freezing-motion issue is always a key challenge to tackle for both 2D and 3D pose sequence generation.  
